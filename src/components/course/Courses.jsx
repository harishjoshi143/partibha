...
//                       <Link
//                         to={`/our-courses/${item.slug || item.categoryName?.toLowerCase().replace(/\s+/g, "-") || "computer-course"}`}
...
//                             {item.courses?.length || 0} {item.courses?.length === 1 ? "Course" : "Courses"}
//                           </p>
//                         </div>

//                         {/* Image */}
//                         {item.imageCategory?.url ? (
//                           <img
//                             className="w-full h-full object-cover rounded-[30px] group-hover:scale-110 duration-300"
//                             src={item.imageCategory.url}
//                             alt={item.categoryName}
//                           />
//                         ) : (
//                           <div className="w-full h-full bg-gray-300 rounded-[30px] flex items-center justify-center text-gray-600">
//                             No Image
//                           </div>
//                         )}
//                       </Link>
